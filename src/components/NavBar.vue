        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
              <div
                class="dropdown-menu-title d-flex justify-content-between"
                data-backround-image="/image1.png"
              >
                <div>
                  <h6 class="text-uppercase font-size-12 m-b-0">Messages</h6>
                  <small class="font-size-11 opacity-7"
                    >1 unread messages</small
                  >
                </div>
                <div class="dropdown-submenu">
                  <a
                    href="#"
                    class="dropdown-toggle no-icon"
              ...
              <div class="dropdown-menu-body">
                <ul class="list-group list-group-flush">
                  <a
                    href="#"
                    class="list-group-item d-flex link-1 hide-show-toggler"
                  >
                    <div>
                  ...
                  <a
                    href="#"
                    class="list-group-item d-flex link-1 bg-light hide-show-toggler"
                  >
                    <div>
                      <figure class="avatar avatar-xs m-r-15">
                    ...
                    <div class="flex-grow-1">
                      <h6 class="m-b-0 d-flex justify-content-between">
                        ...
                        <i
                          title="Read Mark"
                          data-toggle="tooltip"
                          class="hide-show-toggler-item fa fa-circle-o font-size-11"
                        ></i>
                      </h6>
                  ...
                  <a
                    href="#"
                    class="list-group-item d-flex align-items-center link-1 hide-show-toggler"
                  >
                    <div>
                      <figure class="avatar avatar-xs m-r-15">
              ...
              <div class="dropdown-menu-body p-t-b-15 p-l-r-20">
                <div class="timeline">
                  <div class="timeline-item">
                    <div>
                      <figure
                        class="avatar avatar-state-danger avatar-sm m-r-15 bring-forward"
                      >
                        <span
                  ...
                  <div class="timeline-item">
                    ...
                    <div>
                      <p class="m-b-5">
                        <a href="#">Katherine</a> changed settings to ticket
                        category
                  ...
                  <div class="timeline-item">
                    <div>
                      <figure class="avatar avatar-sm m-r-15 bring-forward">
                        <span
                          class="avatar-title bg-danger-light text-danger rounded-circle"
                        >
                    ...
                    <div>
                      <p class="m-b-5">
                        <a href="#">Natalie</a> reassigned ticket Problem
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
              ...
              >
                <figure
                  class="avatar avatar-state-success avatar-sm m-b-10 bring-forward"
                >
              ...
              <div class="dropdown-menu-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <a href="#" class="list-group-item link-2 d-flex"
                    >Followers <span class="text-muted ml-auto">214</span></a
                  >
                  <a
                    href="#"
